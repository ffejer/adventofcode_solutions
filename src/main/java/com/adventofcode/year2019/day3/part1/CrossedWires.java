...
public class CrossedWires {
  ...
  static int solve(String wire1, String wire2) {
    ...
    SetUtils.SetView<Pair<Integer, Integer>> intersection = SetUtils.intersection(wire1Coordinates,
        wire2Coordinates);
    Integer integer = intersection.stream().map(p -> Math.abs(p.getLeft()) + Math.abs(p.getRight()))
