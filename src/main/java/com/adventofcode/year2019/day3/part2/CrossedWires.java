...
public class CrossedWires extends AbstractProblemSolution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solve("R75,D30,R83,U83,L12,D49,R71,U7,L72", "U62,R66,U55,R34,D71,R55,D58,R83"));
        System.out.println(solve("R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51", "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7"));
    }
    ...
    static int solve(String wire1, String wire2) {
        ...
        SetUtils.SetView<Pair<Integer, Integer>> intersections = SetUtils.intersection(new HashSet<>(wire1Coordinates), new HashSet<>(wire2Coordinates));
        result = intersections.stream().map(i -> wire1Coordinates.indexOf(i) + wire2Coordinates.indexOf(i) + 2).min(Integer::compareTo).orElse(0);
