package com.adventofcode.year2022.day4.part2;
...
public class CampCleanup extends AbstractProblemSolution {
  ...
  private void solve() {
    ...
    for (String line : input) {
      ...
      if (anyOverlap(Integer.parseInt(team1[0]), Integer.parseInt(team1[1]),
  ...
  boolean anyOverlap(int teamAFrom, int teamATo, int teamBFrom, int teamBTo) {
    ...
    return (teamBFrom >= teamAFrom && teamBFrom <= teamATo) || (teamAFrom >= teamBFrom
        && teamAFrom <= teamBTo);
  }
